...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDForegroundColor = [UIColor colorWithRed:80/255.0f green:144/255.0f blue:187/255.0f alpha:1.0f]; //[UIColor colorWithRed:45/255.0f green:167/255.0f blue:195/255.0f alpha:1.0f]; //
