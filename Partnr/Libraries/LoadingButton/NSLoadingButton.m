...
#import "NSLoadingButton.h"

@interface NSLoadingButton(){
    NSLoadingButtonAlignment _activityIndicatorAlignment;
}
...
@implementation NSLoadingButton
...
-(void)commonInit {
    ...
    _activityIndicatorAlignment = NSLoadingButtonAlignmentCenter;
...
-(CGRect)frameForActivityIndicator {
    ...
    switch (_activityIndicatorAlignment) {
        case NSLoadingButtonAlignmentLeft:
        {
...
//            frame.origin.y = _activityIndicatorEdgeInsets.top;
            ...
            break;
        case NSLoadingButtonAlignmentCenter:
        {
            frame.origin.x = ((self.frame.size.width - frame.size.width) / 2);
        }
            break;
        case NSLoadingButtonAlignmentRight:
        {
